 ...
 * 
 * Self-contained pipeline infrastructure for the product-domain domain:
...
export interface ProductDomainPipelineStackProps extends cdk.StackProps {
  domain: string;
...
export class ProductDomainPipelineStack extends cdk.Stack {
  public readonly artifactBucket: s3.Bucket;

  constructor(scope: Construct, id: string, props: ProductDomainPipelineStackProps) {
