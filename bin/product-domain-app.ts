...
import { ProductDomainPipelineStack } from "../lib/product-domain-pipeline-stack";
...
new ProductDomainPipelineStack(
  app,
  "ProductDomainPipelineStack",
  {
    ...
    prodAccountId,
    githubConnectionArn,
    description: "Domain-scoped pipeline for product-domain",
  }
);
